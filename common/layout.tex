% Use proper margins.
% \geometry{letterpaper,left=1.25in,top=1in,right=1.25in,bottom=1in,nohead} % ORIGINAL
\geometry{letterpaper,left=1in,top=1in,right=1in,bottom=1in,nohead}         % RJN EDIT
...
% Omit page numbers (RJN: I don't think I want to omit these page numbers, commented out)
