...
% Front Matter: 2in top margin
% \newgeometry{left=1.25in,top=2in,right=1.25in,bottom=1in,nohead}
\newgeometry{left=1.25in,top=2in,right=1in,bottom=1in,nohead}       % RJN edit: 1" right margin
\pagenumbering{roman}
...
% RJN: I think this "\restoregeometry" command should come AFTER \inputing the ABSTRACT. See req for Abstract to have 2" top margin. I hard-coded this.
\restoregeometry                                    
...
%9. List of Symbols (if needed)

% Transition from Roman numbering (i, ii, iii, etc.) back to Arabic numbering (1, 2, 3, ...)
